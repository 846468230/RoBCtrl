...
class GaussianDiffusion(nn.Module):
    ...
    def calculate_for_diffusion(self):
        ...
        self.posterior_variance = (   #  cal 8 The two coefficient values of sigma are calculated in Formula 8
        ...
        self.posterior_mean_coef1 = (     # cal 8 The two coefficient values of mu are calculated in Formula 8
            self.betas * th.sqrt(self.alphas_cumprod_prev) / (1.0 - self.alphas_cumprod)
        )
        self.posterior_mean_coef2 = (    # cal 8 The two coefficient values of mu are calculated in Formula 8
    ...
    def p_mean_variance(self, model, x, t):   # why the model mean can be seen as the x_0^hat
        """
